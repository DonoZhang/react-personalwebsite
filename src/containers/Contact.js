				...
				<div className='row'>
					<div style={this.props.display} className='contact-form'>
						<form onSubmit={this._sendEmail}>
							<div><input onChange={this.handleNameChange} type='text' placeholder='Name' value={this.state.name} required/></div>
							<div><input onChange={this.handleEmailChange} type='text' placeholder='Email' value={this.state.email} required/></div>
							<div><textarea onChange={this.handleMessageChange} placeholder='Message' value={this.state.message} required/></div>
					...
					<div style={this.props.display} className='information'>
						...
						<p><Github/><span><a className='github' target='_blank' href="https://github.com/DonoZhang">https://github.com/DonoZhang</a></span></p>
					</div>		
				</div>
			</Page>
		)
