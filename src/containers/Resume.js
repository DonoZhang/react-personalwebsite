                        ...
                        <div className='technical-skills' style={this.props.display}>
                            ...
                            <Accordion buttonNames={['Front-end', 'back-end']} collapse={false}>
                                <ul>
                                    ...
                                    <li>CSS<progress value='80' max='100'></progress></li>
                                    <li>HTML5<progress value='80' max='100'></progress></li>
                                    <li>React.js<progress value='60' max='100'></progress></li>
                                    <li>jQuery<progress value='60' max='100'></progress></li>
                                    <li>Bootstrap<progress value='80' max='100'></progress></li>
                                </ul>
                                <ul>
                                    <li>Node.js(express)<progress value='40' max='100'></progress></li>
                                    <li>C#(.net)<progress value='60' max='100'></progress></li>
                                    <li>PHP<progress value='40' max='100'></progress></li>
                                    <li>SQL<progress value='90' max='100'></progress></li>
                                </ul>
                            </Accordion>
                        </div>
                    </div>
